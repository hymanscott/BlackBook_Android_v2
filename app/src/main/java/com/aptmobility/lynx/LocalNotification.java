...
public class LocalNotification  {
    ...
    public String execute(Context context,String action, JSONArray optionsArr, String callBackId) {
        mcontext = context;
	 ...
	 * by one.
	 */
	final SharedPreferences alarmSettings = mcontext.getSharedPreferences(PLUGIN_NAME, Context.MODE_PRIVATE);
	...
	final Editor alarmSettingsEditor = mcontext.getSharedPreferences(PLUGIN_NAME, Context.MODE_PRIVATE).edit();
