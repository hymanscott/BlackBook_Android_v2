...
public class TestingInstructionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                public void onClick(View v) {
                    for (int i = 0; i < testingInsTable.getChildCount(); i++) {
                        ...
                        if (row == v) {
                            ...
                            ((TextView) ((TableRow) testingInsTable.getChildAt(i)).getChildAt(0)).setTextColor(getResources().getColor(R.color.blue_theme));
        ...
        /*for (final TestingInstructions Instructions : testing_instruction_list) {
            final Button instruction_title = new Button(getActivity());
            ...
            instruction_title.setTextColor(getResources().getColor(R.color.blue_theme));
            ...
            instruction_title.setPadding(10, 30, 10, 30);
            ...
            instruction_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (buttonView.getCurrentTextColor() == getResources().getColor(R.color.blue_theme)) {
