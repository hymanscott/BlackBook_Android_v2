...
public class encounter_new_partner extends FragmentActivity {
    DatabaseHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(android.R.id.content, new partner_addNewPartner())
                            //.addToBackStack(null)
                    .commit();
        }
    ...
    */
    ...
    public boolean onAddNewPartnerNext(View view) {
        ...
        partner_NewPartner_ContactInfo fragPartnerContactInfo = new partner_NewPartner_ContactInfo();
        ...
        if (nickName.isEmpty()) {
            ...
            Partners new_partner = new Partners(LynxManager.getActiveUser().getUser_id(), LynxManager.encryptString(nickName), LynxManager.encryptString(hiv_status),
    ...
    public boolean onContactInfoNext(View view) {
        partner_NewPartner_Notes fragNewPartnerNotes = new partner_NewPartner_Notes();
    ...
    public boolean onPartnerNotesNext(View view) {
        partner_NewPartner_ratings fragPartnerRatings = new partner_NewPartner_ratings();
    ...
    public boolean onPartnerRatingsNext(View view) {
        partner_NewPartner_Summary fragPartnerSummary = new partner_NewPartner_Summary();
    ...
    public boolean onPartnerSummaryNext(View view) {
        partner_NewPartner_logged fragnewpartnerLogged = new partner_NewPartner_logged();
        ...
        encounter_choosePartner choosePartner = new encounter_choosePartner();
