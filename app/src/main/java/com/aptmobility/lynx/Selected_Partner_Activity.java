...
public class Selected_Partner_Activity extends FragmentActivity {
    ...
    */
    ...
    public boolean onAddNewPartnerNext (View view){
        EditPartner_ContactInfo fragEditContactInfo = new EditPartner_ContactInfo();
    ...
    public boolean onContactInfoNext (View view){
        ...
        EditPartner_Notes fragEditNotes = new EditPartner_Notes();
    ...
    public boolean onPartnerNotesNext (View view){
        EditPartner_Ratings fragEditRatings = new EditPartner_Ratings();
    ...
    public boolean onPartnerRatingsNext (View view){
        EditPartner_Summary fragEditSummary = new EditPartner_Summary();
