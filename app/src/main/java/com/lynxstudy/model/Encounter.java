...
public class Encounter {
    ...
    public Encounter(int encounter_id,int user_id, String datetime, int partner_id, String rate_the_sex, String is_drug_used,String encounter_notes, String is_possible_sex_tomorrow,String status_update,boolean status_encrypt,String created_at) {
