 ...
 */
public class SelectedPartnerSummaryFragment extends Fragment {

    DatabaseHelper db;
    public SelectedPartnerSummaryFragment() {
    }
    TextView hivStatus,emailtv,mobile,city,met,social,typePartner,notesPartner,overAll;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        city.setTypeface(tf);
        met = (TextView) rootview.findViewById(R.id.met);
        met.setTypeface(tf);
